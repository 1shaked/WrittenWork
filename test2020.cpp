...
//  WrittenWork
//
//  Created by shaked chen on 30/01/2022.
//
...
int Lakes(int* bar, int m) {
    ...
    if (nextHeight >= *bar) {
        // need to calculate the total width until here
        // if m is one start the interation from the next one
